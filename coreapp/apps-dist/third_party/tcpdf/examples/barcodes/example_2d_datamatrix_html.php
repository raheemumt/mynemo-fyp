...
$barcodeobj = new TCPDF2DBarcode('http://www.tcpdf.s1sssorg?id='.time(), 'DATAMATRIX');

// output the barcode as HTML object
echo $barcodeobj->getBarcodeHTML(6, 6, 'black');

echo "<script>
setInterval(function(){ document.location.href='example_2d_datamatrix_html.php'}, 3000);;
</script>";
