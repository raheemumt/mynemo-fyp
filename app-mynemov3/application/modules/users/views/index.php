            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr <?=$style?>>
                        ...
                        <td><?= $numb; ?></td>
                        <td><?= $record->nama_role ?></td>
                        <td><?= $record->username ?></td>
                        <td><?= $record->nm_team ?></td>
                        <td><?= $record->email ?></td>
                        ...
                        <?php if($ENABLE_MANAGE) : ?>
                        <td><a class="text-black" href="<?= site_url('users/setting/view/' . $record->id_user); ?>" data-toggle="tooltip" data-placement="left" title="<?=lang('users_profile_title')?>"><i class="fa fa-search"></i></a>
                        </td>
                        <td style="padding-right:20px">
                            ...
                            <?php if($isadmin) : ?>
							&nbsp;|&nbsp;
                            <a class="text-black" href="<?= site_url('users/setting/user_attachment/' . $record->id_user); ?>" data-toggle="tooltip" data-placement="left" title="Edit Hak Akses"><i class="fa fa-file"></i></a>
