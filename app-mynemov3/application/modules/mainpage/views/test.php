...
<div id="demo">
	...
	<a class="sidebar-link" id="button" name="button" href="#" aria-expanded="false">test</a>
    <!--<button id="button" type="button">Change Content</button>-->
	<input name="t01" type="hidden" id="t01" value="3">
  </div>
<nav>
	<ul>
		<?php $session_lang = get_lang_sis(); ?>
	  <a class="nav-link" data-toggle="dropdown" href="#" id="selected-language">  
		<?php 
			if($session_lang == "en")
				{ echo "<i class='flag-icon flag-icon-gb mr-2'></i>";} 
			else
				{ echo "<i class='flag-icon flag-icon-my mr-2'></i>";} 
		?>
		</a>
	<li class="nav-item dropdown" >

		<select class="nav-link" id="languages" name="languages" data-toggle="dropdown">		
			<option class="dropdown-item"><?php //if($session_lang == "en"){ echo "English";}else{echo  "Bahasa Melayu";} ?></option>

			<option class="dropdown-item <?php //if($session_lang == "en"){ echo "active";}else{} ?>" value="en"><i class="flag-icon flag-icon-gb mr-2"></i> English</option>
			
			<option class="dropdown-item <?php //if($session_lang == "ms"){ echo "active";}else{} ?>" value="ms"><i class="flag-icon flag-icon-my mr-2"></i> Bahasa Melayu</option>
		</select>
		...
		(function () {
			...
			$.ajax({
				url: "<?=site_url("dashboard/lang_pick")?>",  // define here controller then function name
				method: 'POST',
