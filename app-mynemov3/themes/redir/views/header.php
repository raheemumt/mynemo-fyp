			...
			<div class="app-header with-horizontal">
			  ...
			  <ol class="breadcrumb mb-0">
				<li class="breadcrumb-item">
				  <span class="text-primary text-decoration-none" href="javascript:void(0)"><?php if (!empty($id)) echo $platform->T01_NAMA_BI;?></span>
				</li>
				<li class="breadcrumb-item active" aria-current="page"><?php if (!empty($id)) echo $platform->T02_NAMA_APP;?></li>
			  </ol>
