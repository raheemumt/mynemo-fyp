...
?>
	...
	<!-- tambah-->
 	...
 	<!-- end tambah -->
		...
		<?php echo $this->load->view("todo/script_todo"); ?> 
		<footer>
			
		<div class="border-top text-center fs-2 p-2" style="color: #ABABAB ;">MyNemo v3.0 by Center for Digital Ecosystem, Universiti Malaysia Terengganu <?php echo $tt;
?> Seconds)</div>
		</footer>
