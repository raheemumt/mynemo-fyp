...
<!-- ################################## --> 
			 ...
			 <!--  Sidebar End -->
				<div class="page-wrapper">
				  ...
				  <header class="topbar" style="background: linear-gradient(to right, #773ebd 0%, #a878e3 100%);">
						  ...
						  <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">                
							...
							<li class="nav-item hover-dd dropdown">
							  ...
							  <div class="dropdown-menu dropdown-menu-start content-dd dropdown-menu-animate-up mailbox" aria-labelledby="drop2">
								  ...
								  <div>
								    <a class="d-flex align-items-center pt-3 pb-2 justify-content-center text-dark" href="javascript:void(0);" onClick="t_reload()">
							...
							<li class="nav-item hover-dd dropdown" id="tododummy" style="display: none">
							  <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" aria-expanded="false">
								  <iconify-icon icon="solar:checklist-minimalistic-outline"></iconify-icon>
							  </a>
					...
					<!--<li class="nav-item hover-dd dropdown" id="todoloader" style="display:<?php //(isset($_SESSION["todo"])) ? "none" : "block"  ?>">
			...
			<div class="app-header with-horizontal">
			  ...
			  <ul class="navbar-nav quick-links d-none d-xl-flex">
				...
				<!-- ---------------------------------- -->    
				  ...
				  <li class="nav-item hover-dd dropdown" id="todopanel" style="display:<?=(isset($_SESSION["todo"])) ? "block" : "none"  ?>">
					  <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" aria-expanded="false">
						  <iconify-icon icon="solar:checklist-minimalistic-outline"></iconify-icon>
						  <div class="notify">
						    <span class="heartbit"></span> <span class="point"></span>
				   ...
				   <script type="text/javascript">
						function t_reload() {
							...
							$.ajax({
								url: '<?=base_url()?>todo/todo_reload',
								type: 'post',
								//data: { s_todo: '<?php //echo $_SESSION["todo"];?>'} ,
				  ...
				  <li class="nav-item hover-dd dropdown" id="tododummy" style="display: none">
					...
					<!-- ------------------------------- -->
					<li class="nav-item hover-dd dropdown" id="todoloader" style="display:<?=(isset($_SESSION["todo"])) ? "none" : "block"  ?>">
					  <a class="nav-link nav-icon-hover" href="#" id="drop2" aria-expanded="false">
						<iconify-icon icon="eos-icons:loading"></iconify-icon>
					  </a>
					</li>
			...
			<?php
			  ...
			  if( strtolower( $session_lang ) == 'my' )
			  {
				echo "my=".$session_lang;
				$icoLang = 'icon-flag-my.png';
				 $search = "Carian Aplikasi";
			  }
			  else
			  {			  
				  echo "en=".$session_lang;
				  $icoLang = 'icon-flag-en.svg';
			  ...
			  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
				<div class="d-flex align-items-center justify-content-between px-0 px-xl-8">
				  ...
				  <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
					...
					<li class="nav-item search-box d-none text-white d-md-flex align-items-center">
					  <div class="nav-link">
						<form name="searching" id="searching" class="app-search position-relative" action="<?=base_url()?>app" method="post">
						  <input type="text" name="nama" class="form-control rounded-pill border-0 shadow-none" placeholder="<?=$search?>" />
					...
					<li class="nav-item hover-dd dropdown">
					  <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" aria-expanded="false">
						<img src="<?=base_url()?>assets/images/svgs/<?= $icoLang; ?>" alt="" width="20px" height="20px"
						  class="rounded-circle object-fit-cover round-20" />
					  </a>
					  <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
						<div class="message-body" id="languages">
						  <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item lang" data-lang="EN">
							...
							<p class="mb-0 fs-3">Englishxx (UK)</p>
						  </a>
