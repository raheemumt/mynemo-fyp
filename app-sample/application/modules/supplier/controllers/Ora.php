...
class Ora extends Adminx_Controller {
	...
	{		
		...
		$where = "DELETED IS NULL 
                AND (COV_MATRIK LIKE '%$search2%' OR COV_NAMA_PELAJAR LIKE '%$search2%')";
	...
	public function create()
   	{
        ...
        if (isset($_POST['save']))
        {
            ...
            { 
              ...
              redirect('supplier/ora/confirm/'.$id);
            }
        }
	...
	function confirm($id="1")
	{
		...
		$codeContents = 'mynemo.umt.edu.my/ocean/index.php/skrol/index/'.$id; 
		...
		$this->template->render('parent/confirm');
	}
