  ...
  <div class="card">
	...
	<div class="card-body">
	  ...
	  <div class="mb-4 row align-items-center">
	   ...
	   <div class="row">
                          <div class="col-sm-3"><a class="btn btn-warning" href="<?=module_url("ccc/listmohon")?>"><< Pulang Semula</a></div>
                          <div class="col-sm-9 text-end">
                            <div class="d-flex align-items-center gap-6 text-end">
							  <button class="btn bg-danger-subtle text-danger">Tidak Sokong</button>
                              <a class="btn btn-primary" href="<?=module_url("ccc/listmohon")?>">Sokong >></a>
