...
<div class="col-lg-12">
  <div class="card">
	...
	<div class="card-body">
		...
		<div class="mb-4 row align-items-center">
			<label for="startDate" class="form-label fw-semibold col-sm-2 col-form-label text-end">Pengesahkan Oleh</label>
			<div class="col-sm-10">
			  <div class="input-group">
		...
		<div class="mb-4 row align-items-center">
			<label for="startDate" class="form-label fw-semibold col-sm-2 col-form-label text-end">Kelulusan Oleh</label>
			<div class="col-sm-10">
			  <div class="input-group">
				PROFESOR Ts. MUHAMMAD SUZURI BIN HITAM (09/11/2024)
			  </div>
			</div>
		</div>
		<div class="mb-4 row align-items-center">
