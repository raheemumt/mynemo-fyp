...
<div class="card">
        ...
        <div class="card-header">Senarai Bench Fee Bagi Pelajar Tidak Aktif</div>
...
<th><?=lang('cov_bank_kod')?> (RM)</th>
	  ...
	  <?php if($ENABLE_MANAGE) { ?>
		<input type="button" name="delete1" class="btn btn-danger" id="sa-success" value="Proses Ke Pool Benchfee Fakulti" onclick="confirm_delete(this.form) ">
