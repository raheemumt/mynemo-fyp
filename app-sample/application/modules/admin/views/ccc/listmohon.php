            ...
            <div class="card card-body">
              <div class="row">
                ...
                <div
				  ...
				  <?php if ($ENABLE_ADD) : ?>
	  	        <a href="<?= module_url('ccc/tnc') ?>" class="btn btn-primary d-flex align-items-center" title="<?= lang('ccc_btn_new') ?>"><i class="ti ti-users text-white me-1 fs-5"></i><?= lang('ccc_btn_new') ?></a>
                <?php endif; ?>
                </div>
              </div>
            </div>
...
<th>Lihat</th>
                ...
                <tbody>
					...
					<tr>
					    <td>2</td>
						<td>SAMPLING DI TASIK KENYIR DAN GAJAH</td>
						<td>12/10/2024</td>
						<td>12/10/2024</td>
						<td>14/10/2024</td>
						<td>14/10/2024</td>						
